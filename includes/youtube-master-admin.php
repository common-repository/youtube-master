...
if ( is_admin() )
add_menu_page( 'Tube Master', 'Tube Master', 'manage_options', 'youtube-master', 'youtube_master_admin', plugins_url( 'youtube-master/images/techgasp-minilogo-16.png' ) );
}
		///////////////////////
		// WORDPRESS ACTIONS //
		///////////////////////
...
if(!class_exists('youtube_master_admin_table_header')){
	require_once( WP_PLUGIN_DIR . '/youtube-master/includes/youtube-master-admin-table-header.php');
}
...
if(!class_exists('youtube_master_admin_table_news')){
	require_once( WP_PLUGIN_DIR . '/youtube-master/includes/youtube-master-admin-table-news.php');
}
//Prepare Table of elements
